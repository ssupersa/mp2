...
<div class="wrapper">
  ...
  <aside class="main-sidebar bg-light elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-bold">{{ $title ?? "Event Stmik" }}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
        ...
        <div class="info">
          <a href="#" class="d-block text-dark font-weight-semibold">{{ auth()->user()->name }}</a>
        </div>
      </div>
      ...
      <div class="form-inline mb-3">
        <div class="input-group" data-widget="sidebar-search">
          ...
          <div class="input-group-append">
            <button class="btn btn-primary btn-sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="fas fa-calendar-check nav-icon"></i> <!-- Ubah ke ikon yang sesuai -->
                <p>
                    Laporan Kegiatan
                    <i class="right fas fa-angle-left"></i>
                </p>
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('laporan-kegiatan.index') }}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
  ...
  <style>
    ...
    .nav-link:hover {
      background-color: #5355ec; /* Orange background color on hover */
      color: #000000; /* White text color on hover */
    }
  
    .nav-icon {
      color: #5355ec; /* Orange icon color */
      transition: color 0.3s;
    }
  
    .nav-link:hover .nav-icon {
      color: #000000; /* White icon color on hover */
    }
  </style>
